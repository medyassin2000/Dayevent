 ...
 */
class getCommandeTicketRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommandeTicketRepository' shared autowired service.
     *
     * @return \App\Repository\CommandeTicketRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommandeTicketRepository.php';

        return $container->privates['App\\Repository\\CommandeTicketRepository'] = new \App\Repository\CommandeTicketRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
