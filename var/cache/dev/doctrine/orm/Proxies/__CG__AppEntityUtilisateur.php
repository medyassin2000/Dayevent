...
class Utilisateur extends \App\Entity\Utilisateur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'nom', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'prenom', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'role', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'telephone', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'motDePasse', '' . "\0" . 'App\\Entity\\Utilisateur' . "\0" . 'datenaiss'];
        }
     ...
     * {@inheritDoc}
     */
    public function setTelephone(int $telephone): \App\Entity\Utilisateur
    {
     ...
     * {@inheritDoc}
     */
    public function setDatenaiss(\DateTimeInterface $datenaiss): \App\Entity\Utilisateur
    {
