...
return [
    ...
    'users_data' => [[], ['_controller' => 'App\\Controller\\CommandeTicketController::usersData'], [], [['text', '/commande/ticket/data']], [], [], []],
    'users_data_download' => [['id'], ['_controller' => 'App\\Controller\\CommandeTicketController::usersDataDownload'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/commande/ticketdata/download']], [], [], []],
